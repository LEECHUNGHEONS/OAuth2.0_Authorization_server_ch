...
import com.gopang.client.repository.PasswordResetTokenRepository;
import com.gopang.client.repository.UserRepository;
import com.gopang.client.repository.VerificationTokenRepository;
...
public class UserServiceImpl implements UserService {
    ...
    // 토큰의 사용자를 검증하고 토큰의 유효시간을 확인 및 검증
    @Override
    ...
    @Override
    public boolean checkIfValidOldPass(User user, String oldPassword) {
